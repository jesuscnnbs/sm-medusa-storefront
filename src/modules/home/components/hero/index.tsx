...
const Hero = () => {
  return (
    <div className="min-h-[700px] w-full border-b border-ui-border-base relative overflow-hidden bg-secondary-sm">
      <Image
      ...
      />
      <div className="absolute inset-0 flex flex-col items-center justify-center p-4 gap-14">
